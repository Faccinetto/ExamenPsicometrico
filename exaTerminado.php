        ...
        <div class="exams col-sm-12 d-flex justify-content-center">
            ...
            <div class="terminacion col-sm-12 d-flex justify-content-center">
                <div class="nas col-sm-6 d-flex justify-content-center">
                    <h2 >Culminaste tus examenes <br> Epera tur resultados <br> Nosotros nos pondremos en contacto contigo</h2>
                    <button type="button" class="btn-info bns acce">Regresar a mi perfil</button>
                </div>
